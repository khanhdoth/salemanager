...
public class ContactController extends FacadeController<Contact> implements Serializable {
    ...
    private final String updateReportString = ":businessContactForm:iPGBusinessContactList, :businessContactForm:apContactDetail:iStockOutTable, :businessContactForm:apContactDetail:iStockInTable";
